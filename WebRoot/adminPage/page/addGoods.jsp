			...
			<ul id="nav_dot">
				...
				<s:if test="#session.admin.adminAuthority == 0 ">
					...
					<li>
						...
						<div class="list-item none">
							<a
								href="admin_show!findAdminByAuthority.action?pageIndex=1&adminAuthority=2">订单管理员</a>
							<a
								href="admin_show!findAdminByAuthority.action?pageIndex=1&adminAuthority=1">商品管理员</a>
							<a
								href="admin_show!findAdminByAuthority.action?pageIndex=1&adminAuthority=3">订单配送员</a>
						</div>
					</li>
				</s:if>
			</ul>
		...
		<div class="m-right">
			...
			<div class="main" align="center">
				<div align="center" style=" margin:20px; line-height:28px;">
					<s:form action="goods_show!addGoods.action" method="post"
