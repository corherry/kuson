...
<body>
	...
	<div id="header">
		...
		<div class="navigation">
			<ul>
				<li>欢迎您：</li>
				<li><a href="adminPage/page/adminInformation.jsp"
					target="adminInfo"><s:property value="#session.admin.adminName"></s:property></a></li>
				<li>| <a href="adminPage/index.jsp" target="adminInfo">&nbsp;我的主页</a></li>
				<li>| <a href="adminPage/page/resetPassword.jsp"
					target="adminInfo">&nbsp;修改密码</a></li>
		...
		<div class="m-right">
			...
			<div class="main">
				<div align="center" style=" margin:20px;">
					<table border = "1" cellpadding="1" cellspacing="1" width="350px"
						style="border-color:#C0C0C0; text-align:center;font-size:18px;">
						<tr>
						...
						<tr>
							<td>类型</td>
							<td><s:if test="#session.admin.adminAuthority==0">系统管理员</s:if>
								<s:if test="#session.admin.adminAuthority==1">商品管理员</s:if> <s:if
									test="#session.admin.adminAuthority==2">订单管理员</s:if></td>
						</tr>
					</table>
				</div>
			</div>
