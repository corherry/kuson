			...
			<div class="main">
				<div align="center" style=" margin:20px; line-height:28px;">
					<s:form action="goods_show!updateGoods.action" method="post" namespace="/" enctype="multipart/form-data">
    					...
    					<s:textfield name="goods.goodsDescription" label="商品描述" value="%{#session.goods.goodsDescription}"></s:textfield>
    					<s:select list="%{categoryList}" listKey="cid" listValue="category" label="类别" name="typeId" value="%{#session.goods.type.typeId}"></s:select>
