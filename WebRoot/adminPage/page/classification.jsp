		...
		<div class="m-right">
			...
			<div class="main">
			  <div align="center" style=" margin:20px;">
			  	 <p align="center"><a href="adminPage/page/addFirstType.jsp"><img src="adminPage/images/add.png" title="添加类别"/></a></p>
				 <table border ="1" cellspacing = "0" cellpadding = "0" align ="center" width = "80%">
                   <tr>
                     <th width="30%">序号</th><th width="40%">一级类别</th><th width="30%">操作</th>
                   </tr>
                   <c:forEach var = "classify" items = "${pageBean.list}">
                	...
                	<a href="category!showFirstCategory.action?pageIndex=1">首页</a>
					<a href="category!showFirstCategory.action?pageIndex=${pageBean.pageIndex-1}">上一页</a>
					<a href="category!showFirstCategory.action?pageIndex=${pageBean.pageIndex+1}">下一页</a>
					<a href="category!showFirstCategory.action?pageIndex=${pageBean.totalPage}">末页</a>
