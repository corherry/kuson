...
<body>
	...
	<div id="header">
		...
		<div class="navigation">
			<ul>
				<li>欢迎您：</li>
				<li><a href="adminPage/page/adminInformation.jsp" target="adminInfo">${admin.adminName}</a></li>
			...
			<ul id="nav_dot">
				<li>
					...
					<div class="list-item none">
						<a href="adminPage/page/adminInformation.jsp" target="adminInfo">基本信息</a>
						<a href="adminPage/page/resetPassword.jsp" target="adminInfo">修改密码</a>
					</div>
				</li>
