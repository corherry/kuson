...
<div class="header">
	<div class="container">
		...
		<c:if test="${imfo!=null}">
		<script type="text/javascript"> window.onload=function(){a();}</script>
		</c:if>
            <li>Hi,欢迎来到酷森旗舰店</li>
		...
		<li><a href="user_logoff!logoff.action" ><span class="glyphicon glyphicon-time" aria-hidden="true"></span>退出</a></li>
		</c:if>
		</ul>
	</div>
</div>
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">&nbsp;&nbsp;&nbsp;${firstCategory}&nbsp;&nbsp;&nbsp; <span class="caret"></span></a>
						...
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="../adminPage/images/${product.goodsPicUrl}" alt="" class="pro-image-front">
									<img src="../adminPage/images/${product.goodsPicUrl}" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="../goods_show!findGoodsInfo.action?goodsNo=${product.goodsNo}" class="link-product-add-cart">商品详情</a>
											</div>
										</div>
								</div>
								<div class="item-info-product ">
									<h4><a href="goods_show!findGoodsInfo.action?goodsNo=${product.goodsNo}">${product.goodsTitle}</a></h4>
									...
									<div class="login-bottom">
										...
										<form>
                                              <div class="sign-up">
												...
												<h4><img class="img1" src="images/person07.png" /></h4>
											...
											<div class="sign-up">
												...
												<input type="password" value="" onFocus="this.value = '';" required>
							...
							<div class="login-grids">
								<div class="login">
									<div class="login-bottom">
										...
										<s:form action="../user_login!login.action" method="post" theme="simple" namespace="/">
											<div class="sign-up">
											    <c:if test="${imfo!=null}">
