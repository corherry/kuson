	...
	<div class="container">
		...
		<div class="col-md-8 products-right iframe01">
             <div class="bs-docs-example">
            	<s:form action="../user_resetPassword!resetPassword.action" method="post"
			...
			<table class="table table-bordered">
				...
				<tbody>
					<tr>
					    <td>旧密码</td>
					    <td><s:password name="user.password"/>${errors["user.password"][0]}					       
					    </td>
					</tr>
					<tr>
						<td>新密码</td>
						<td><s:password name="newPassword" />${errors.newPassword[0]}</td>
					</tr>
					<tr>
						<td>确认密码</td>
						<td><s:password name="rePassword" />${errors.rePassword[0]}</td>
					</tr>
					<tr>
						<td align="center" colspan="2"><s:submit value="确认修改" /></td>
					</tr>
				</tbody>
			</table>
		</s:form>
							...
							<div class="login-grids">
								<div class="login">
									<div class="login-bottom">
										<h3>免费注册</h3>
										<form  action="../user_register!register.action" onsubmit="check()">
									<div class="sign-up">
