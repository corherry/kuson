	...
	<div class="container">
		...
		<div class="col-md-8 products-right iframe01">
			...
			<table class="table table-bordered" style="text-align: center;">
				<thead>
					<tr>
						<th colspan="6" align="center">收货地址</th>
					</tr>
				</thead>
				<tbody>
				    <tr>
				    ...
				    <c:forEach var="address" items="${pageBean.list}">
					  <% cas++; %>
					<tr>
					    <td><%= cas %></td>
				        ...
				        <td>
				            <a href="../show_address!deleteAddress.action?addressId=${address.addressId}"><img src="images/delete1.png" title="删除地址"/></a>
				        </td>
					</tr>
					</c:forEach>
				</tbody>
			...
			<c:if test="${pageBean.totalPage > 0}">
 				 <a href="../show_address!showAddress.action?pageIndex=1">首页</a>
				 <a href="../show_address!showAddress.action?pageIndex=${pageBean.pageIndex-1}">上一页</a>
				 <a href="../show_address!showAddress.action?pageIndex=${pageBean.pageIndex+1}">下一页</a>
				 <a href="../show_address!showAddress.action?pageIndex=${pageBean.totalPage}">末页</a>
